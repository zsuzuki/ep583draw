...
// 指定コードのフォントを探す
const Hint*
search(uint16_t code, const Hint* hint, int num)
{
...
//
void
Font::convCode(const char*& ptr, uint32_t& code)
{
  convcode(ptr, code);
}
...
//
void
Font::getFont(uint32_t code, FontBitmap& bitmap) const
{
...
//
bool
Font::LoadFile(const char* fname)
{
  return false;
}
...
//
bool
Font::AssignMappedMemory(const void* p)
{
